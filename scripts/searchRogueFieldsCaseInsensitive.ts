...
async function run() {
  console.log('Searching all collections for "Skripsi" or "Saintek" or "DELF" (case-insensitive)...');
  ...
  for (const coll of collections) {
    ...
    snap.docs.forEach(doc => {
      ...
      if (dataStr.includes('skripsi') || dataStr.includes('saintek') || dataStr.includes('delf')) {
