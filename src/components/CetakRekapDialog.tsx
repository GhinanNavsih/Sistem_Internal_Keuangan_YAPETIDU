...
interface CetakRekapDialogProps {
  open: boolean;
...
export default function CetakRekapDialog({
  open,
  onOpenChange,
  periodName,
  onPrintPdf,
  onExportXlsx,
}: CetakRekapDialogProps) {
  return (
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <DialogTitle className="text-xl font-bold tracking-tight text-slate-800">
                Format Unduhan Rekap Gaji
              </DialogTitle>
              <DialogDescription className="text-sm text-slate-500 mt-0.5">
                Silahkan pilih format laporan Rekapitulasi Gaji untuk periode {periodName}
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
        ...
        <div className="p-6">
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              ...
              <p className="text-[11px] text-slate-400 max-w-[140px] leading-normal">Laporan Rekapitulasi Gaji dalam format PDF siap cetak.</p>
            </button>
